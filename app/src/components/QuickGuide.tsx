...
const topics = [
  ...
  [
    ...
    "In Track, choose Private sail to record on this phone without an account or internet. Choose Regatta to sign in and select your boat and regatta, then tap Start live sharing. This starts GPS tracking and sharing together; you do not need to start a private recording first. Sharing makes your boat’s position, speed and trail public live and in replay after you stop. Existing live-only sessions are not added to replay. Anyone can browse published regattas and watch without signing in. An account alone does not grant entry: you must accept a skipper invitation or own/edit the boat, and the organizer must have entered it in a published heat and opened tracking. Find regattas opens the website; after arranging entry with the organizer, refresh the list. Private recordings are never uploaded automatically. Stop an active private recording before switching to Regatta; the previous recording stays in History.",
  ],
  [
    "Nautical map layer",
