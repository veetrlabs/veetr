      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        {currentView === "location" && (
          <>
            ...
            <LocationSettings />
            <TouchableOpacity accessibilityRole="button" onPress={() => router.push("/regatta-sharing")} style={{ paddingVertical: 18 }}>
              <Text style={{ color: colors.text, fontSize: 16 }}>Share boat location in a regatta</Text>
            </TouchableOpacity>
          </>
        )}
