import PhoneHistory from "../../tracking/PhoneHistory";
        ...
        {[10, 60, 720, 1440].map((m) => (
          <TouchableOpacity
            ...
            style={[
              ...
              timeRange === m && { backgroundColor: colors.text },
            ]}
          ...
          >
            <Text
              style={[
                ...
                timeRange === m && { color: colors.chartBg },
              ]}
            >
...
function getStats(data: DataPoint[]) {
  if (data.length === 0)
    return {
      aws: { min: 0, max: 0, avg: 0 },
      tws: { min: 0, max: 0, avg: 0 },
      sog: { min: 0, max: 0, avg: 0 },
    };
    ...
    <View style={{ height: chartHeight + 40, marginVertical: 12 }}>
      ...
      >
        {data.map((point, i) => (
          <View
            key={i}
            style={{ width: groupWidth, flexDirection: "row", gap: 1 }}
          >
            <View
              style={{
                width: barWidth,
                height: (point.AWS / maxVal) * chartHeight,
            ...
            <View
              style={{
                width: barWidth,
                height: (point.TWS / maxVal) * chartHeight,
            ...
            <View
              style={{
                width: barWidth,
                height: (point.SOG / maxVal) * chartHeight,
